...
// `0.0.0.0` (DESIGN.md "Security", listener row).
...
// foreground (DESIGN.md "Architecture"). It is launched by launchd or
// systemd.
...
// runs as root (DESIGN.md "State directory layout": control.sock is owned
