...
// user input (DESIGN.md "セキュリティ", install / uninstall rows). The only
...
// StateDir is the macOS state directory (DESIGN.md "プラットフォーム抽象").
...
// OS-dependent implementation in this package (DESIGN.md "プラットフォーム抽象").
