...
// (DESIGN.md "Routing model") and forwards to `localhost:<port>` with
...
// registration details (DESIGN.md "Registration lifecycle").
//
...
// take tens of seconds (DESIGN.md "Proxy requirements").
...
func (p *Proxy) rewrite(pr *httputil.ProxyRequest) {
	...
	// target is http (DESIGN.md "Proxy requirements").
	...
	// set. The default is not to strip (DESIGN.md "Routing model").
