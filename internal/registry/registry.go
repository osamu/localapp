...
//
// The data model has two levels, App > Service (DESIGN.md "リソースモデル").
...
// Plane API error codes (DESIGN.md "エラー").
...
// (DESIGN.md "ルーティングモデル"). They are ordered so the first element is
